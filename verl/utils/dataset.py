...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        test_input_key: str = "test_input",
        test_output_key: str = "test_output",   
        example_input_key: str = "example_input",
        example_output_key: str = "example_output",
        answer_key: str = "answer",
        image_key: str = "images",
        image_dir: Optional[str] = None,
        max_prompt_length: int = 1024,
        ...
        self.processor = processor
        self.prompt_key = prompt_key
        self.test_input_key = test_input_key
        self.test_output_key = test_output_key
        self.example_input_key = example_input_key
        self.example_output_key = example_output_key
        self.answer_key = answer_key
        self.image_key = image_key
        self.image_dir = image_dir
        self.max_prompt_length = max_prompt_length
